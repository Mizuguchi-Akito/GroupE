...
class BlogListView(LoginRequiredMixin, generic.ListView):
    model = Blog
    template_name = 'blog_kamimura/blog_list.html'
    paginate_by = 2
...
class BlogDetailView(LoginRequiredMixin, generic.DetailView):
    model = Blog
    template_name = 'blog_kamimura/blog_detail.html'

class BlogCreateView(LoginRequiredMixin, generic.CreateView):
    model = Blog
    template_name = 'blog_kamimura/blog_create.html'
    form_class = BlogCreateForm
    success_url = reverse_lazy('blog_kamimura:blog_list')
...
class BlogUpdateView(LoginRequiredMixin, generic.UpdateView):
    model = Blog
    template_name = 'blog_kamimura/blog_update.html'
    form_class = BlogCreateForm

    def get_success_url(self):
        return reverse_lazy('blog_kamimura:blog_detail', kwargs={'pk':self.kwargs['pk']})
...
class BlogDeleteView(LoginRequiredMixin, generic.DeleteView):
    model = Blog
    template_name = 'blog_kamimura/blog_delete.html'
    success_url = reverse_lazy('blog_kamimura:blog_list')
